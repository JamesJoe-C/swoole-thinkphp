...
// $consul_data = array(
//     'ID' => 'sw_service1_web',
//     'Name' => 'sw_service1_web',
//     'Tags' => array('primary'),
//     'Address' => '0.0.0.0',
//     'Port' => 9501,
//     'Check' => array('HTTP' => '0.0.0.0', 'Interval' => '5s'),
// );
 ...
 *  加载consul工具类.
 */
// include SWOOLE_PATH.DIRECTORY_SEPARATOR.'Swoole'.DIRECTORY_SEPARATOR.'Consul.php';
...
function servStart($host, $port, $daemon, $name)
{
    ...
    $server = new SwooleServer($port, 9501);
    $server->run();
    ...
    // $consul->registerService(json_encode($consul_data)); //往Consul里注册服务
}
